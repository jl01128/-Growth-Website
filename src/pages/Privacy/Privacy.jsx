    ...
    return (
        <div className="privacy" style={{ backgroundImage: 'url("/privacyBackground.png")', backgroundSize: 'cover', backgroundPosition: 'center', height: '100%'}}>
            ...
            <div className="privacy-body">
                ...
                application. The Explore application is a education application. By using the Growth+ application, you consent to the data practices described in this 
                statement.</p>
                ...
                <p>Explore welcomes your questions or comments regarding this Statement of Privacy. If you believe that Growth+ has not adhered to this Statement, please contact Growth+ at:</p>
                <p id="contactInfo">Explore<br/></p>
